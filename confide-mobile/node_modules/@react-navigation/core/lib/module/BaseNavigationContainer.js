...
export const BaseNavigationContainer = /*#__PURE__*/React.forwardRef(function BaseNavigationContainer({
  ...
  const consumedParams = useLazyValue(() => new WeakMap());
  ...
  const lastEmittedStateRef = React.useRef(undefined);
  const getIsStateEmitted = useLatestCallback(() => !isFirstMountRef.current && lastEmittedStateRef.current === getState());
  const builderContext = React.useMemo(() => ({
    ...
    flushUpdates,
    stackRef
  }), [addListener, addKeyedListener, onDispatchAction, onEmitEvent, onOptionsChange, getIsStateEmitted, scheduleUpdate, flushUpdates]);
    ...
    children: /*#__PURE__*/_jsx(NavigationContainerRefContext.Provider, {
      ...
      children: /*#__PURE__*/_jsx(NavigationBuilderContext.Provider, {
        ...
        children: /*#__PURE__*/_jsx(NavigationStateContext.Provider, {
          value: context,
          children: /*#__PURE__*/_jsx(ConsumedParamsContext.Provider, {
            value: consumedParams,
